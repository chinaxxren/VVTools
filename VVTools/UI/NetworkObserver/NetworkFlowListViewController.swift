...
class NetworkFlowListViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(newFlowDidReceive(noti:)), name: NSNotification.Name.VVToolsNetworkObserverSoldierNewFlowDidReceive, object: nil)
    }
