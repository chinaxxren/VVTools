...
public class Captain {
    ...
    let floatingWindow = CaptainFloatingWindow(frame: CGRect.zero)

    init() {
        let defaultSoldiers: [Soldier] = [AppInfoSoldier(), SanboxBrowserSoldier(), CrashSoldier(), WebsiteEntrySoldier(), FPSSoldier(), MemorySoldier(), CPUSoldier(), ANRSoldier(), ASLSoldier(), NetworkObserverSoldier.shared, UserDefaultsSoldier()]
        ...
        logoImage = ImageManager.imageWithName("VVTools_icon_shield")!
    }
